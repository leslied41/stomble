    ...
    <>
      <ScreenLayout header="Settings" goBack>
        <View className="py-6 flex-row align-center items-center">
          <Image
            source={{
              uri: "https://cdn-icons-png.flaticon.com/512/1785/1785888.png",
            }}
            className="w-10 h-10 rounded-full items-center justify-center"
            style={{ backgroundColor: "yellow" }}
          />
          <Text className="text-[18px] font-[400] text-white ml-4 leading-[22px]">
            John Sarkis
          </Text>
        </View>
        <View
          style={{ height: 0.7, backgroundColor: "#cacaca" }}
          className="mx-[-22px]"
        />
        <AccountsSettingsView />
        <View
